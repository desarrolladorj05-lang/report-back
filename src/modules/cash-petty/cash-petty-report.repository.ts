...
import {
  ...
  CashPettyDetailResult,
} from "src/database/procedures-documentation/cash-petty-detail";
import {
  CashPettyReportProcedure,
  CashPettyReportResult,
} from "src/database/procedures-documentation/cash-petty.report";
...
export class CashPettyReportRepository extends BaseRepository<any> {
  ...
  async getCashPettyReport(
    year: number,
    month: number,
  ): Promise<CashPettyReportResult> {
